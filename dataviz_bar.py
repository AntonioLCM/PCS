...
plt.bar(data.index, data["Exit3"], label="Exit3", bottom=data["Exit1"] + data["Exit2"])
plt.bar(data.index, data["Exit4"], label="Exit4", bottom=data["Exit1"] + data["Exit2"] + data["Exit3"])
plt.legend()
plt.xlabel("Step")
